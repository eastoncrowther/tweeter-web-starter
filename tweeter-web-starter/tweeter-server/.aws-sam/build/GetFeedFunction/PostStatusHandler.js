...
// ../tweeter-shared/dist/model/domain/Follow.js
var require_Follow = __commonJS({
  "../tweeter-shared/dist/model/domain/Follow.js"(exports) {
    "use strict";
...
// ../tweeter-shared/dist/model/domain/PostSegment.js
var require_PostSegment = __commonJS({
  "../tweeter-shared/dist/model/domain/PostSegment.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    (function(Type2) {
      ...
      Type2["alias"] = "Alias";
      Type2["url"] = "URL";
      Type2["newline"] = "Newline";
    })(Type || (exports.Type = Type = {}));
    var PostSegment = class {
      _text;
      _startPostion;
      _endPosition;
      _type;
...
// ../tweeter-shared/dist/model/domain/User.js
var require_User = __commonJS({
  "../tweeter-shared/dist/model/domain/User.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.User = void 0;
    var User = class _User {
      ...
      static fromJson(json) {
        if (!!json) {
          ...
          return new _User(jsonObject._firstName, jsonObject._lastName, jsonObject._alias, jsonObject._imageUrl);
        } else {
          return null;
        }
      }
      ...
      static fromDto(dto) {
        return dto == null ? null : new _User(dto.firstName, dto.lastName, dto.alias, dto.imageUrl);
      }
    };
    exports.User = User;
  }
...
// ../tweeter-shared/dist/model/domain/Status.js
var require_Status = __commonJS({
  "../tweeter-shared/dist/model/domain/Status.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.Status = void 0;
    var PostSegment_1 = require_PostSegment();
    ...
    var Status = class _Status {
      ...
      getPostSegments(post) {
        const segments = [];
        let startIndex = 0;
        for (let reference of _Status.getSortedReferences(post)) {
      ...
      static getSortedReferences(post) {
        const references = [
          ..._Status.parseUrlReferences(post),
          ..._Status.parseMentionReferences(post),
          ..._Status.parseNewlines(post)
        ];
        references.sort((a, b) => {
      ...
      static parseUrlReferences(post) {
        const references = [];
        const urls = _Status.parseUrls(post);
      ...
      static parseUrls(post) {
        ...
        for (let word of post.split(/(\s+)/)) {
          if (word.startsWith("http://") || word.startsWith("https://")) {
            const endIndex = _Status.findUrlEndIndex(word);
      ...
      static findUrlEndIndex(word) {
        ...
        if (word.includes(".com")) {
          ...
          index = word.length;
          while (!_Status.isLetter(word[index])) {
            index--;
          }
        }
        return index;
      ...
      static parseMentionReferences(post) {
        const references = [];
        const mentions = _Status.parseMentions(post);
        let previousStartIndex = 0;
      ...
      static fromJson(json) {
        if (!!json) {
          const jsonObject = JSON.parse(json);
          return new _Status(jsonObject._post, new User_1.User(jsonObject._user._firstName, jsonObject._user._lastName, jsonObject._user._alias, jsonObject._user._imageUrl), jsonObject._timestamp);
        } else {
          return null;
        }
      }
...
// ../tweeter-shared/dist/model/domain/AuthToken.js
var require_AuthToken = __commonJS({
  "../tweeter-shared/dist/model/domain/AuthToken.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.AuthToken = void 0;
    var uuid_1 = (init_esm_node(), __toCommonJS(esm_node_exports));
    var AuthToken = class _AuthToken {
      _token;
      _timestamp;
      static Generate() {
        const token = _AuthToken.generateToken();
        const timestamp = Date.now();
        return new _AuthToken(token, timestamp);
      }
      ...
      static fromJson(json) {
        if (!!json) {
          const jsonObject = JSON.parse(json);
          return new _AuthToken(jsonObject._token, jsonObject._timestamp);
        } else {
          return null;
        }
      }
      ...
      static fromDto(dto) {
        return dto == null ? null : new _AuthToken(dto.token, dto.timestamp);
      }
    };
...
// ../tweeter-shared/dist/util/FakeData.js
var require_FakeData = __commonJS({
  "../tweeter-shared/dist/util/FakeData.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.FakeData = void 0;
    var AuthToken_1 = require_AuthToken();
    var Status_1 = require_Status();
    var User_1 = require_User();
    var MALE_IMAGE_URL = "https://faculty.cs.byu.edu/~jwilkerson/cs340/tweeter/images/donald_duck.png";
    var FEMALE_IMAGE_URL = "https://faculty.cs.byu.edu/~jwilkerson/cs340/tweeter/images/daisy_duck.png";
    var FakeData2 = class _FakeData {
       ...
       */
      static get instance() {
        if (_FakeData._instance == null) {
          _FakeData._instance = new _FakeData();
        }
      ...
      generateFakeStatuses() {
        ...
        Or do you prefer this one: http://cs.byu.edu?`;
            const timestamp = timestampStart + 3e10 * (i * this.fakeUsers.length + j);
...
// ../tweeter-shared/dist/index.js
var require_dist = __commonJS({
  "../tweeter-shared/dist/index.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    Object.defineProperty(exports, "Follow", { enumerable: true, get: function() {
      return Follow_1.Follow;
    } });
    var PostSegment_1 = require_PostSegment();
    Object.defineProperty(exports, "PostSegment", { enumerable: true, get: function() {
      return PostSegment_1.PostSegment;
    } });
    Object.defineProperty(exports, "Type", { enumerable: true, get: function() {
      return PostSegment_1.Type;
    } });
    var Status_1 = require_Status();
    ...
    var AuthToken_1 = require_AuthToken();
    Object.defineProperty(exports, "AuthToken", { enumerable: true, get: function() {
      return AuthToken_1.AuthToken;
    } });
    var FakeData_1 = require_FakeData();
    Object.defineProperty(exports, "FakeData", { enumerable: true, get: function() {
      return FakeData_1.FakeData;
    } });
  }
});

// src/lambda/PostStatusHandler.ts
var PostStatusHandler_exports = {};
__export(PostStatusHandler_exports, {
  handler: () => handler
});
module.exports = __toCommonJS(PostStatusHandler_exports);

// src/model/service/StatusService.ts
...
var StatusService = class {
  async loadMoreFeedItems(token, userAlias, pageSize, lastItem) {
    const [statuses, hasMorePages] = import_tweeter_shared.FakeData.instance.getPageOfStatuses(
      lastItem ? import_tweeter_shared.FakeData.instance.findStatusByPost(lastItem.post) : null,
      pageSize
    );
  ...
  async postStatus(token, post, userAlias, timestamp) {
  }
};
